...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-1xnxkeq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-1xnxkeq.containers.anotherwebservice.com/
...
```
git clone git@github.com:MrBwoken/container-1xnxkeq.git
cd container-1xnxkeq
```
...
```
docker attach container-1xnxkeq
```
